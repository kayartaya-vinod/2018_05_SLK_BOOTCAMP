...
<body>
	...
	<form action="./add-person" id="f1" method="POST">
		...
		<div>
			...
			<input type="text" id="email" name="email" size="50" placeholder="enter email">
		</div>
		
		<div>
			<label for="phone">Phone number</label>
			<input type="text" id="phone" name="phone" size="30" placeholder="enter phone">
		</div>
